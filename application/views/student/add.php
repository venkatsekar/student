                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group" id="data_2">
                                                ...
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="brotherDob" name="brotherDob" placeholder="DD/MM/YYYY" type="text" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group" id="data_3">
                                                <label>Sister D.O.B</label>
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input id="sisterDob" name="sisterdob" type="text" class="form-control"  placeholder="DD/MM/YYYY">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="firstScoreCards" class="form-control" id="firstScoreCards">
                                            </div>
                                             <div class="form-group">
                                                <label>Second score cards</label>
                                                <input type="text" name="secondScoreCards" class="form-control" id="secondScoreCards">
                                            </div>
                                             <div class="form-group">
                                                <label>Third score cards</label>
                                                <input type="text" name="thirdScoreCards" class="form-control" id="thirdScoreCards">
                                            </div>
                                            <div class="form-group">
