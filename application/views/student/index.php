...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                 <h2><a class="btn btn-info" href="<?=BASEURL?>student/add">Add Student</a></h2>  
                </div>
            </div>
    ...
    $(document).ready(function(){
           $('.dataTables-example').DataTable({
               "processing": true,
                "serverSide": true,
                "ajax": "<?=BASEURL?>student/list_student"
...
function delete_user_student(userInfoId,studentInfoId,studentSubjectId) {
    swal({
        title: "Are you sure?",
