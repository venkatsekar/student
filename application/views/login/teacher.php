...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <h3>Welcome to Teacher</h3>
            <form class="m-t" role="form" action="<?=BASEURL?>login/login" method="POST">
                ...
                <a href="<?=BASEURL;?>login/passwordrecover"><small>Forgot password?</small></a>
                <p class="text-muted text-center"><small>Do not have an account?</small></p>
                <a class="btn btn-sm btn-white btn-block" href="<?=BASEURL;?>login/registration">Create an account</a>
            </form>
