                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
											...
											<div class="form-group">
                                                ...
                                                <input id="emailAddress" name="emailAddress" type="text" class="form-control required" value="<?=@$EditTeacher[0]['email_id'];?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Password *</label>
                                                <input id="password" name="password" type="text" class="form-control required" value="<?=@$EditTeacher[0]['password'];?>">
                                            </div>
                                            <div class="form-group">
                                                <label>Confirm Password *</label>
                                                <input id="confirm" name="confirm" type="text" class="form-control" value="<?=@$EditTeacher[0]['password'];?>">
                                            </div>
											<div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="ifsc" name="ifsc" type="text" class="form-control" value="<?=@$EditTeacher[0]['ifsc_code'];?>">
                                            </div>
											<div class="form-group">
												<label>Class room</label>
												<input id="classRoom" name="classRoom" type="text" class="form-control" value="<?=@$EditTeacher[0]['class_room'];?>">
											 </div>
										</div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                            ...
                                            <div class="form-group" id="data_1">
                                                ...
                                                <div class="input-group date">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" placeholder="DD/MM/YYYY" name="dob" id="dob" value="<?=@$EditTeacher[0]['date_of_birth'];?>">
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label>Bank accno</label>
                                                <input id="bankAccno" name="bankAccno" type="text" class="form-control" value="<?=@$EditTeacher[0]['bank_account_number'];?>">
                                            </div>
											<div class="form-group">
                                                <label>Bank name</label>
                                                <input id="bankName" name="bankName" type="text" class="form-control" value="<?=@$EditTeacher[0]['bank_name'];?>">
                                            </div>
											<div class="form-group">
                                                <label>Bank branch</label>
                                                <input id="bankBranch" name="bankBranch" type="text" class="form-control" value="<?=@$EditTeacher[0]['branch_name'];?>">
                                            </div>
										</div>
                                    </div>
                                </fieldset>
                                        ...
                                        <div class="col-lg-12">
											...
											<div class="form-group" id="data_5">
                                                ...
                                                <div class="input-daterange input-group" id="datepicker">
                                                    <input type="text" class="input-sm form-control" id="currentSchoolJoin" name="currentSchoolJoin" value="<?=@$EditTeacher[0]['current_school_joining_date'];?>"/>
                                                    <span class="input-group-addon">to</span>
                                                    <input type="text" class="input-sm form-control" id="currentSchoolToJoin" name="currentSchoolToJoin"  value="<?=@$EditTeacher[0]['current_school_joining_to_date'];?>"/>
                                                </div>
                                            </div>
											<div class="form-group">
											...
											<div class="form-group" id="data_6">
                                                ...
                                                <div class="input-daterange input-group" id="datepicker">
                                                    <input type="text" class="input-sm form-control" id="prevSchoolJoin" name="prevSchoolJoin" value="<?=@$EditTeacher[0]['previous_school_joining_date'];?>"/>
                                                    <span class="input-group-addon">to</span>
                                                    <input type="text" class="input-sm form-control" id="prevSchoolToJoin" name="prevSchoolToJoin"  value="<?=@$EditTeacher[0]['previous_school_joining_to_date'];?>"/>
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label>Remarks</label>
