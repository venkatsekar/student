                        ...
                        <div class="ibox-content">
                            ...
                            <form role="form" id="form">
                                    <div class="form-group">
                                        <input type="hidden" name="eduSettingId" id="eduSettingId" value="<?=$EditSettings[0]['edu_setting_id'];?>"/>
                                        <label>Company name *</label>
                                        <input type="text" placeholder="" class="form-control required" name="companyName" id="companyName" value="<?=$EditSettings[0]['company_name'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Student terms</label>
                                        <input type="text" placeholder="" class="form-control" name="studentTerm" id="studentTerm" value="<?=$EditSettings[0]['terms_students'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Teacher terms</label>
                                        <input type="text" placeholder="" class="form-control" name="teacherTerm" id="teacherTerm" value="<?=$EditSettings[0]['terms_teachers'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" placeholder="" class="form-control" name="address" id="address" value="<?=$EditSettings[0]['address_1'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>city</label>
                                        <input type="text" placeholder="" class="form-control" name="city" id="city" value="<?=$EditSettings[0]['city'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>State</label>
                                        <input type="text" placeholder="" class="form-control" name="state" id="state" value="<?=$EditSettings[0]['state'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Primary phone</label>
                                        <input type="text" placeholder="" class="form-control" name="primaryPhone" id="primaryPhone" value="<?=$EditSettings[0]['primary_ph_no'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Secondary phone</label>
                                        <input type="text" placeholder="" class="form-control" name="secondaryPhone" id="secondaryPhone" value="<?=$EditSettings[0]['secondary_ph_no'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Email Id *</label>
                                        <input type="text" placeholder="" class="form-control reuired" name="emailAddress" id="emailAddress" value="<?=$EditSettings[0]['email_id'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Registration No</label>
                                        <input type="text" placeholder="" class="form-control" name="regNo" id="regNo" value="<?=$EditSettings[0]['registration_no'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Remarks</label>
                                        <input type="text" placeholder="" class="form-control" name="remarks" id="remarks" value="<?=$EditSettings[0]['remarks'];?>">
                                    </div>
                                    <div align="center">
