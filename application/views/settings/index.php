...
<head>
    ...
    <title>EDUCATION | SETTINGS</title>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                 <h2><a class="btn btn-info" href="<?=BASEURL?>settings/add">Add Settings</a></h2>  
                </div>
            </div>
    ...
    <script>
      $(document).ready(function(){
           $('.dataTables-example').DataTable({
               "processing": true,
                "serverSide": true,
                "ajax": "<?=BASEURL?>settings/list_setting"
...
function deletesettings(eduSettingId)
{
  swal({
        title: "Are you sure?",
        ...
        if (!isConfirm) return;
        $.ajax({
            url: "<?=BASEURL?>settings/delete_settings",
            type: "POST",
            data: {
                eduSettingId: eduSettingId
            },
            success: function () {
