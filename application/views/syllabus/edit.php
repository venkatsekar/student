...
<body>
        ...
        ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                 ...
                 <div class="col-lg-2">
                 <h2><a class="btn btn-info" href="<?=BASEURL?>syllabus">Back to Syllasbus</a></h2>  
                </div>
            </div>
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                           ...
                           <form role="form" id="form">
                                    <input type="hidden" name="syllabusId" id="syllabusId" value="<?=$EditSyllabus[0]['syllabus_id'];?>"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="classId" class="form-control" id="classId" required>
                                            ...
                                            <?php foreach($ClassList as $_c){
                                                if($_c['class_id'] == $EditSyllabus[0]['class_id']){?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="studentSubjectId" class="form-control" id="studentSubjectId" required>
                                            ...
                                            if($_s['subject_id'] == $EditSyllabus[0]['subject_id']){?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="langId" class="form-control" id="langId" required>
                                            ...
                                            if($_s['lang_id'] == $EditSyllabus[0]['lang_id']){?>
                                                <option value="<?=$_s['lang_id'];?>" selected="selected"><?=$_s['lang_name'];?></option>
                                            <?} else {?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="" class="form-control" name="lessonName" id="lessonName" value="<?=$EditSyllabus[0]['lesson_name'];?>">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Remarks</label>
                                        <input type="text" placeholder="" class="form-control" name="remarks" id="remarks" value="<?=$EditSyllabus[0]['remarks'];?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Description</label>
                                        <textarea class="form-control" name="description" id="description"><?=$EditSyllabus[0]['other_desc'];?></textarea>
                                    </div><br/><br/>
    ...
    <script>
        $(document).ready(function(){
             ...
             $.ajax({
                 type: "POST",
                 url: "<?=BASEURL?>syllabus/edit_syllabus",
                 data: $(form).serialize(),
