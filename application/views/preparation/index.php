...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        ?>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                 <h2><a class="btn btn-info" href="<?=BASEURL?>preparation/add">Add Prepartaion</a></h2>  
                </div>
            </div>
    ...
    $(document).ready(function(){
           $('.dataTables-example').DataTable({
               "processing": true,
                "serverSide": true,
                "ajax": "<?=BASEURL?>preparation/list_preparation"
...
function delete_preparation(preparationModuleId, moduleLessonId) {
    swal({
        ...
        if (!isConfirm) return;
        $.ajax({
            url: "<?=BASEURL?>preparation/delete_preparation",
            type: "POST",
            data: {
                preparationModuleId: preparationModuleId, 
