...
<body>
                        ...
                        <div class="ibox-content">
                            ...
                            <form role="form" id="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="" class="form-control" name="virtualRackName" id="virtualRackName">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="" class="form-control" name="noTest" id="noTest">
                                    </div>
                                    <div class="form-group">
                                        <label>Test Duration</label>
                                        <input type="text" placeholder="" class="form-control" name="testTiming" id="testTiming">
                                    </div>
                                    <div class="form-group">
                                        <label>Home work</label>
                                        <input type="text" placeholder="" class="form-control" name="homeWork" id="homeWork">
                                    </div>
                                   <div class="form-group">
                                        <label>Examination Timing</label>
                                        <input type="text" placeholder="" class="form-control" name="examTiming" id="examTiming">
                                    </div>
                                    <div class="form-group">
                                        <label>Remarks</label>
    ...
    <script>
        $(document).ready(function(){
             ...
             $.ajax({
                 type: "POST",
                 url: "<?=BASEURL?>preparation/add_preparation",
                 data: $(form).serialize(),
                 success: function (data) {
                    ...
                    else
                    {
                      ...
                      confirmButtonText: "OK"
                          ...
                          window.location.href = "<?=BASEURL?>preparation/add";
                    });
                    }
                }
             });
